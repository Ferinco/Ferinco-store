    ...
    <Wrapper className="left d-flex flex-column">
        <div className="left-body">
            <div className="left-body-text p-3">
                ...
                <p className="px-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eleifend ante sed lectus <br/> bibendum aliquet. Aenean commodo justo ut justo finibus, a efficitur ex consequat. <br/> In at placerat nisi, vitae tincidunt nunc. Aliqua</p>
            </div>
            <div className="left-body-bottom d-flex flex-row">
