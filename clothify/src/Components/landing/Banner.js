  ...
  return (
    <Wrapper className="container banner d-flex flex-column justify-content-center align-items-center text-center gap-0 mt-5">
      ...
      <div className="banner-div d-flex flex-column w-100 h-100">
        ...
        <div className="image-div d-flex flex-row align-items-center xl-justify-content-center">
          ...
          <div className="div-3">
            <img src="/Images/three-friends.png"/>
          </div>
...
const Wrapper = styled.div`
  ...
  .div-3 {
    ...
    border-radius: 15px;
    background-image: url(/Images/three-friends.png) !important;
